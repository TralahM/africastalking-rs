...
[![Rust Docs](https://github.com/tralahm/africastalking-rs/actions/workflows/release-core.yml/badge.svg?tag=v0.1.2)](https://github.com/tralahm/africastalking-rs/actions/workflows/release-core.yml)
...
```shell
cargo add --git https://github.com/tralahm/africastalking-rs --tag=v0.1.2
```
...
[dependencies]
# africastalking = "0.1"
africastalking = { git = "https://github.com/tralahm/africastalking-rs", tag = "v0.1.2" }
```
